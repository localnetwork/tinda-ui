...
export default function StoreCard({
  ...
  useEffect(() => {
    const sampleFnc = async () => {
      if (store_banner) {
        const isDark = await detectImageLightOrDark(store_banner);
  ...
  return (
    <div className="py-[20px]">
      ...
      >
        <div
          className={`absolute z-[1]  top-[5px] right-[5px] ${
            isBannerDark ? "text-white" : "bg-[#212121f]"
          }`}
        >
          <Link href={`/seller-center/${uuid}`}>
            <svg
        ...
        >
          <div className="font-bold text-left mb-2 line-clamp text-ellipsis overflow-hidden">
